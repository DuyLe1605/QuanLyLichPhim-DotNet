...
file_path = r'd:\Study\.Net\BaiTapLon\BaiTapLon\Forms\Admin\Customers\UcCustomerManagement.cs'
...
for i, line in enumerate(lines):
    if "private Control CreateDetailPanel()" in line:
        start_idx = i
    if "return panel;" in line and start_idx != -1:
        end_idx = i + 1
        break

if start_idx != -1 and end_idx != -1:
    new_code = """    private Control CreateDetailPanel()
    {
...
"""
    ...
    print("Could not find CreateDetailPanel")
